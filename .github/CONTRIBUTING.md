...
## How can I help? ##
SpoilerSeason grabs its data from many sources, but those sources often contain errors.  If you just want to improve the card data and fix errors, you can start in the [errors.json](https://github.com/tritoch/SpoilerSeason/blob/files/errors.json) file in the [files branch](https://github.com/tritoch/SpoilerSeason/tree/files) or our [issue tracker.](https://github.com/tritoch/SpoilerSeason/issues)
